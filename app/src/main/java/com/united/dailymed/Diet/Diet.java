...
public class Diet extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_diet_plan_landing);
            ...
            btnaddDetails.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    Intent i = new Intent(Diet.this, AddDietPlan.class);
                    startActivity(i);
                }
            });
        ...
        btnviewDetails.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent i = new Intent(Diet.this, DietPlan.class);
                startActivity(i);
            }
        });
    ...
    private void onLeftSwipe() {
        Intent i = new Intent(Diet.this, Water.class);
        startActivity(i);
