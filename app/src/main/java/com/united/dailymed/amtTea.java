...
public class amtTea extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_it20198336_createnewteacup);




        //getting the ids of required components
        seekTea = findViewById(R.id.seekBarTea);
        txtTea = findViewById(R.id.txtamounttea);
        btnTeaAdded = findViewById(R.id.btnTeaDone);

        //setting the method when seek bar value is changed
        seekTea.setOnSeekBarChangeListener(new SeekBar.OnSeekBarChangeListener() {
            @Override
            public void onProgressChanged(SeekBar seekBar, int progress, boolean b) {
                txtTea.setText(progress + " ");//setting the progress value to text view
            }
    ...
    public void updateAmount(View view){
        ...
        Double amt = Double.parseDouble(txtTea.getText().toString());
...
//            toast.show();
            ...
            Intent i = new Intent(amtTea.this,Waterdashboard.class);
            startActivity(i);
    ...
    public void cancelTea(View v){
        ...
        alertDialogBuilder.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface arg0, int arg1) {
                Intent i = new Intent(amtTea.this,Selectwateramount.class);
                startActivity(i);
            }
        });
