...
import com.united.dailymed.Heart.HeartRateUpdate;
...
public class HeartRateRVAdapter extends RecyclerView.Adapter<HeartRateRVAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        // to our views of recycler view item.
            ...
            holder.heartRateTV.setText(modal.getHeartRate());
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        private TextView heartRateTV, dateTV,id;

        public ViewHolder(@NonNull View itemView) {
            super(itemView);
            // initializing our text views
            heartRateTV = itemView.findViewById(R.id.idTVCourseName);
            dateTV = itemView.findViewById(R.id.idTVCourseDescription);
