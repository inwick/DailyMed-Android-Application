...
public class amtCustom extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        seekCustom = findViewById(R.id.seekBarCustom);
        txtCustom = findViewById(R.id.txtamountcustom);
        btnCustomAdded= findViewById(R.id.btnCustomDone);

        //setting the method when seek bar value is changed
        seekCustom.setOnSeekBarChangeListener(new SeekBar.OnSeekBarChangeListener() {
            @Override
            public void onProgressChanged(SeekBar seekBar, int progress, boolean b) {
                txtCustom.setText(progress + " ");//setting the progress value to text view
            }
    ...
    public void updateAmount(View view){
        ...
        Double amt = Double.parseDouble(txtCustom.getText().toString());
...
//            toast.show();
            ...
            Intent i = new Intent(amtCustom.this,Waterdashboard.class);
            startActivity(i);
    ...
    public void cancelCola(View v){
        ...
        alertDialogBuilder.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface arg0, int arg1) {
                Intent i = new Intent(amtCustom.this,Selectwateramount.class);
                startActivity(i);
            }
        });
